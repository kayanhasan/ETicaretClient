...
export class Product {
  ...
  create(product:Create_Product,successCallBack?:()=>void,errorCallBack?:(erorMessage:string)=>void){
  ...
  async read(page:number=0,size:number=5,successCallBack?:()=>void,errorCallBack?:(erorMessage:string)=>void):Promise<{totalProductCount:number,products:List_Product[]}>{
